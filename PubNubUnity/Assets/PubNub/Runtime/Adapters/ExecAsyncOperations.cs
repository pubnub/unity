...
namespace PubnubApi.Unity {
	public static class ExecAsyncOperations {
		...
		public static async void Execute(this HistoryOperation h, System.Action<PNHistoryResult, PNStatus> callback) {
			var res = await h.ExecuteAsync();
			callback?.Invoke(res.Result, res.Status);
		}

		public static FetchHistoryOperation Channels(this FetchHistoryOperation o, List<string> channels) {
		...
		public static RemovePushChannelOperation Channels(this RemovePushChannelOperation o, List<string> c) {
			return o.Channels(c.ToArray());
		}
		...
		public static AddPushChannelOperation Channels(this AddPushChannelOperation o, List<string> c) =>
			o.Channels(c.ToArray());
		...
		public static MessageCountsOperation Channels(this MessageCountsOperation o, List<string> channels) =>
			o.Channels(channels.ToArray());

		public static MessageCountsOperation ChannelsTimetoken(this MessageCountsOperation o, List<long> c) =>
			o.ChannelsTimetoken(c.ToArray());
		...
		public static SetStateOperation Channels(this SetStateOperation o, List<string> c) {
			return o.Channels(c.ToArray());
		}

		// GetPresenceState
		public static async void Execute(this GetStateOperation o, System.Action<PNGetStateResult, PNStatus> callback) {
			var res = await o.ExecuteAsync();
			callback?.Invoke(res.Result, res.Status);
		}

		public static GetStateOperation Channels(this GetStateOperation o, List<string> c) {
			return o.Channels(c.ToArray());
		}

		public static GetStateOperation ChannelGroups(this GetStateOperation o, List<string> c) {
			return o.ChannelGroups(c.ToArray());
		}

		public static SetStateOperation ChannelGroups(this SetStateOperation o, List<string> c) {
			return o.ChannelGroups(c.ToArray());
		}
		...
		public static AddChannelsToChannelGroupOperation Channels(this AddChannelsToChannelGroupOperation o,
