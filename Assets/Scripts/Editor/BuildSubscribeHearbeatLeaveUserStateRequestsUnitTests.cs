...
namespace PubNubMessaging.Tests
{
    ...
    public class BuildSubscribeHearbeatLeaveUserStateRequestUnitTests
    {
        ...
        public void TestBuildSubscribeRequestCommon(string[] channels, object timetoken, string userState,
            ...
            Uri uri = BuildRequests.BuildMultiChannelSubscribeRequestV2 (string.Join(",",channels), "", timetoken.ToString(), userState, uuid,
                "", "", ssl,
                pubnub.Origin, pubnub.AuthenticationKey, Common.SubscribeKey, 0
            );
            ...
            string expected = string.Format ("http{0}://{1}/v2/subscribe/{2}/{3}/0?uuid={5}&tt={4}{6}{7}{8}&pnsdk={9}",
        ...
        public void TestBuildLeaveRequestCommon(string[] channels, bool ssl, string authKey){
            ...
            Uri uri = BuildRequests.BuildMultiChannelLeaveRequest (string.Join(",",channels), "", uuid, ssl, 
