...
{
    public class TestCGCHAddListRemoveSubscribeStateHereNowUnsub
    {
        string name = "TestCGCHAddListRemoveSubscribeStateHereNowUnsub";
        ...
        public IEnumerator Start ()
        {
            ...
            yield return DoCGCHAddListRemoveSubscribeStateHereNowUnsub(SslOn, this.name, AsObject, CipherOn, Message, expectedMessage, true);
