...
{
    public class TestDetailedHistoryParams
    {
        string name = "TestDetailedHistoryParams";
        ...
        public IEnumerator Start ()
        {
            ...
            yield return common.DoPublishThenDetailedHistoryAndParse(SslOn, this.name, message, AsObject, CipherOn, NoStore, message.Length, true);
