...
{
    public class TestSubscribeWithTimetoken
    {
        string name = "TestSubscribeWithTimetoken";
        ...
        public IEnumerator Start ()
        {
            ...
            yield return DoTestSubscribeWithTimetoken(SslOn, this.name, AsObject, CipherOn, Message, expectedMessage, true);
