...
{
    public class TestSubscribeDict
    {
        string name = "TestSubscribeDict";
        ...
        public IEnumerator Start ()
        {
            ...
            yield return common.DoSubscribeThenPublishAndParse(SslOn, this.name, AsObject, CipherOn, Message, expectedMessage, true);
