...
{
    public class TestRemoveCGAndRemoveAllCG
    {
        string name = "TestRemoveCGAndRemoveAllCG";
        ...
        public IEnumerator Start ()
        {
            ...
            yield return DoRemoveCGAndRemoveAllCG(SslOn, this.name, AsObject, CipherOn, Message, expectedMessage, true);
